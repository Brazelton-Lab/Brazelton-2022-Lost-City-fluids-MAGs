...
pc = read.csv("bubbles-formate-acetate-v2.csv", header = TRUE)
...
library(plyr)
pcm$Genes = revalue(pcm$variable, c("ackA"="Acetate","pta"="Acetate","cdhA"="Acetate","cdhB"="Acetate","cdhC"="Acetate","cdhD"="Acetate","cdhE"="Acetate","acsB"="Acetate","acsE"="Acetate","acdA"="Acetate","actP"="Acetate","aceP"="Acetate","divergent_FDH"="Formate","acetogen_fdhA"="Formate","acetogen_fdhB"="Formate","fdoG"="Formate","fdoH"="Formate","F420_fdhB"="Formate","fdsD"="Formate","fdsG"="Formate","pflX"="Formate","pflA"="Formate","pflD"="Formate","focA"="Formate","fdhC"="Formate"))

#specify order of gene categories
pcm$Genes = factor(pcm$Genes, levels = c("Acetate", "Formate"))
...
ggsave("bubbles-formate-acetate-v2.svg")
ggsave("bubbles-formate-acetate-v2.png")